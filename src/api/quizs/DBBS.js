const DBBS = [
  ...
  },
  {
    ...
    Answers: [
      ...
      { Id: 103349, Text: "Cung cấp các truy cập đến tổ chức dữ liệu vật lý" },
  ...
  },
  {
    ...
    AnswerId: 103369,
    Answers: [
      { Id: 103367, Text: "Các đối tượng trao đổi thông qua các phương thức" },
      { Id: 103368, Text: "Một đối tượng gồm các thuộc tính, các phương thức" },
      {
        Id: 103369,
        Text: "Các đối tượng không thể được lưu trữ trong cơ sở dữ liệu",
      },
      { Id: 103370, Text: "Các đối tượng có thể được sinh ra từ việc thừa kế" },
    ],
  },
  {
    Id: 24923,
  ...
  },
  {
    ...
    Answers: [
      ...
      { Id: 103377, Text: "Một hệ quản trị cơ sở dữ liệu của hãng Microsoft" },
      {
        Id: 103378,
  ...
  },
  {
    ...
    Answers: [
      ...
      { Id: 103440, Text: "SELECT * FROM EMPLOYEES ORDER BY First_Name DESC" },
      {
        Id: 103441,
