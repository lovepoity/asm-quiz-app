const JABS = [
  ...
  },
  {
    ...
    AnswerId: 108165,
    Answers: [
      { Id: 108163, Text: "Chương trình sẽ được biên dịch và chạy thành công" },
      {
        Id: 108164,
  ...
  },
  {
    ...
    Answers: [
      ...
      { Id: 108185, Text: "super phải sử dụng ở lệnh cuối cùng trong hàm tạo" },
      { Id: 108186, Text: "Chỉ có thể sử dụng trong hàm tạo của lớp cha" },
      { Id: 108187, Text: "super phải sử dụng ở lệnh đầu tiên trong hàm tạo" },
    ],
  },
  {
    Id: 26111,
  ...
  },
  {
    ...
    Answers: [
      ...
      { Id: 108203, Text: "Bao nhiêu tùy ý tùy theo yêu cầu của chương trình" },
    ],
  },
  {
    Id: 26115,
